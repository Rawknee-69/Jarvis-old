...
try:
    ...
    print("wait for nearly 15s")

    # Wait for the page to load
    sleep(15)

    
    cookie_enter = '/html/body/div[1]/div/a'
    driver.find_element(by=By.XPATH, value=cookie_enter).click()
    sleep(1)
...
while True:
    ...
    if len(text) == 0:
        ...
        output_file_path = "C:\\Users\\srija\\Desktop\\AIJarvisl\\Anna\\Body\\SpeechRecognition.txt"
