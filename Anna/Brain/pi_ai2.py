...
def stam():
    ...
    def Introduction():
        ...
        sleep(1)
        driver.find_element(by=By.XPATH, value="/html/body/div[1]/main/div/div/div[3]/div[3]/div/div[2]/button/div/svg").click()
    ...
    def QuerySender(Query):
        Query = str(Query)
        try:
            driver.find_element(by=By.XPATH, value="/html/body/div[1]/main/div/div/div[3]/div[1]/div[4]/div/div/textarea").send_keys(Query)
        except:
            driver.find_element(by=By.XPATH, value="/html/body/div[1]/main/div/div/div[3]/div[1]/div[4]/div/div/textarea").send_keys(Query)
        sleep(0.5)   
    ...
    def ButtonClicker():
        while True:
            SendButton = driver.find_element(by=By.XPATH, value="/html/body/div[1]/main/div/div/div[3]/div[1]/div[4]/div/button").is_enabled()
            if True == SendButton:
                driver.find_element(by=By.XPATH, value="/html/body/div[1]/main/div/div/div[3]/div[1]/div[4]/div/button").click()
                sleep(1)
                break
    def AnswerReturn(Query):
        ...
        while True:
            ...
            if True == SendButton: 
                try:
                    Text = driver.find_element(by=By.XPATH, value="/html/body/div[1]/main/div/div/div[3]/div[1]/div[2]/div/div/div[3]/div/div/div[2]/div[2]").text
                    print(Text)
                    sleep(0.5)
                    try:
                        driver.find_element(by=By.XPATH, value="/html/body/div[1]/main/div/div/div[3]/div[1]/div[4]/div/div/textarea").clear()
                    except:
                        driver.find_element(by=By.XPATH, value="/html/body/div[1]/main/div/div/div[3]/div[1]/div[4]/div/div/textarea").clear()
                    sleep(0.5)
                except:    
